        ...
        <div className='relative isolate'>
            ...
            <div className='overflow-hidden'>
                <div className='mx-auto max-w-5xl px-6 pb-32 pt-12 sm:pt-16 lg:px-8 lg:pt-16'>
                    {/* title */}
                    <PageTitle title='Informacje' subtitle='Przedszkole Cisownica' />
                        ...
                        <dl>
                            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
                                ...
                                <dd className='info-item-dd'>
                                    <strong>Przedszkole Publiczne w Cisownicy</strong>
                                </dd>
                            </div>
                            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
                                <dt className='info-item-dt'>Telefon</dt>
                                <dd className='info-item-dd'>
                                    <strong>33 8528573</strong>
                                </dd>
                            </div>
                            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
                                <dt className='info-item-dt'>Realizowany program</dt>
                                <dd className='info-item-dd'>
                                    <strong>Program wychowania przedszkolnego, Elżbieta Kordos, PWN</strong>
                                </dd>
                            </div>
                        </dl>
                    </div>
