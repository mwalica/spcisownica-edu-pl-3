...
import DocumentsCis from "../../components/DocumentsCis"

function DocumentsCisPage() {
    return (
            ...
            <div className='relative isolate'>
                ...
                <div className='overflow-hidden'>
                    <div className='mx-auto max-w-5xl px-6 pb-32 pt-12 sm:pt-16 lg:px-8 lg:pt-16'>
                        {/* title */}
                        <PageTitle title='Dokumenty' subtitle='Przedszkole Cisownica' />
...
export default DocumentsCisPage