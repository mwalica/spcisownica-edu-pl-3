        ...
        <header>
            <div className='relative isolate'>
                ...
                <div className='overflow-hidden'>
                    <div className='mx-auto max-w-7xl px-6 pb-32 pt-12 sm:pt-16 lg:px-8 lg:pt-32 lg:flex lg:items-center'>
                        {/* left container */}
                        <div className='flex-1 -translate-y-2'>
                            ...
                            <div className='mt-10 flex items-center justify-center lg:justify-start gap-x-6'>
                                <a
                                    href='#notices'
                                    className='rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm uppercase hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                                >
                                    Ogłoszenia
                                </a>
                                <a
                            ...
                            <div className="overflow-hidden rounded-md bg-white shadow w-fit mt-20">
                                <ul role="list" className="flex divide-x divide-gray-200">
                                    ...
                                    <li className="px-6 py-2">
                                        <a href="https://www.spcisownica.edu.pl/dokumenty/statut.pdf" className="text-blue-800 hover:text-blue-900 hover:underline" target="_blank" rel="noreferrer"><PaperClipIcon className="inline h-5 w-5 flex-shrink-0" aria-hidden="true" />{" "}
                                            Statut</a>

                                    </li>
                                    <li className="px-6 py-2">

                                        <Link to="/accessibility" className="text-blue-800 hover:text-blue-900 hover:underline"><LinkIcon className="inline h-5 w-5 flex-shrink-0" aria-hidden="true" />{" "}Deklaracja dostępności</Link>
