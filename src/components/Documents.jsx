...
const generalDocuments = [
    { name: "Statut Szkoły", url: `${import.meta.env.VITE_SITE_DOMAIN}/dokumenty/statut.pdf` },
    { name: "Program wychowawczo-profilaktyczny", url: `${import.meta.env.VITE_SITE_DOMAIN}/dokumenty/wych_prof2021.pdf` },
    { name: "Informacja o przetwarzaniu danych", url: `${import.meta.env.VITE_SITE_DOMAIN}/przetwarzanie_danych_osobowych.pdf` },
    { name: "Biblioteka instrukcja", url: `${import.meta.env.VITE_SITE_DOMAIN}/dokumenty/biblioteka_on_line.pdf` },
]
